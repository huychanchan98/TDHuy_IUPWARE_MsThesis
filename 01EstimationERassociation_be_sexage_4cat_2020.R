...
# We estimate the temperature-related mortality association 
#     using data from BELGIUM

# LOAD OBSERVED DATA - DAILY TEMPERATURE-SERIES
setwd("D:/Belgium/OneDrive - KU Leuven/KUL/Thesis/code/tutorial/be2020")

obs <- read.csv("bel_obs_summer2020.csv",colClasses=c(date="Date"))
#obs <- read.csv("bel_obs_male_age_sm2020.csv",colClasses=c(date="Date"))
#obs <- read.csv("bel_obs_female_age_sm2020.csv",colClasses=c(date="Date"))

# "bel_obs_summer2020.csv" = age group over Belgium summer 2020
# "bel_obs_male_age_sm2020.csv" = sexage (MALE)  group over Belgium summer 2020
# "bel_obs_female_age_sm2020.csv" = sexage (FEMALE)  group over Belgium summer 2020
...
################################################################################
# PLOT - FIGURE 1
#pdf("Fig1_bel_age_summer2020.pdf",height=4.5,width=10)
#pdf("Fig1_bel_male_age_sm2020.pdf",height=4.5,width=10)
#pdf("Fig1_bel_female_age_sm2020.pdf",height=4.5,width=10)
...
plot(pred,"3d",ltheta=150,xlab="Temperature (C)",ylab="Lag",zlab="RR", 
     col=gray(0.9), main="A) Exposure-lag-response")
...
par(mar=c(5,4,3,1),mgp=c(3,1,0),las=1,cex.axis=0.9,cex.lab=1)
plot(pred,"overall",col="red",ylim=c(0.5,2.5),axes=T,lab=c(6,5,7),xlab=xlab,
     ylab="RR",ci="n",main="C) Overall - different functions")
...
#pdf("Fig6_bel_age_summer2020.pdf",height=5,width=9)
#pdf("Fig6_bel_male_age_sm2020.pdf",height=5,width=9)
#pdf("Fig6_bel_female_age_sm2020.pdf",height=5,width=9)
...
plot(pred0_64,"overall",col="magenta",ylim=c(0.5,2.5),axes=T,lab=c(6,5,7),xlab=xlab,
     ylab="RR",ci="n",main="A) Demographic changes", lwd=2)
...
plot(pred,"overall",col="red",ylim=c(0.5,2.5),axes=T,lab=c(6,5,7),xlab=xlab,
     ylab="RR",ci="n",main="B) Adaptation")
