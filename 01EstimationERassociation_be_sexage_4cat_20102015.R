...
#obs <- read.csv("bel_obs_male_age_2010-2015.csv",colClasses=c(date="Date")) 
...
legend(5,2.4,c("No adaptation","With adaptation"),lty=1:2,inset=0.005,
       cex=0.9,bty="n",col=2)
text(9,2.5, "Reduction in heat risk", cex=1)
